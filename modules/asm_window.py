...
#a--------------------------------------------------
try: greet = Gtk.Window.new(Gtk.WindowType.POPUP)
except: 
    greet = Gtk.Window()
...
# a البناء-------------------------------------------------------------------- 
    ...
    def build(self,*a):
        ...
        sav_mark = Gtk.ImageMenuItem.new_with_label("حفظ موضع الصّفحة الحاليّة")
        ...
        menu_action_book.append(Gtk.SeparatorMenuItem())
        win_marks = Gtk.ImageMenuItem.new_with_label("نافذة العلامات المرجعيّة")
        ...
        side_panel = Gtk.ImageMenuItem.new_with_label("إخفاء/عرض اللوح الجانبي")
        ...
        menu_action_edit.append(Gtk.SeparatorMenuItem())
        save_changed = Gtk.ImageMenuItem.new_with_label("حفظ التغييرات في الكتاب")
        ...
        show_normal = Gtk.ImageMenuItem.new_with_label("عرض الكتاب في الوضع العاديّ")
