...
class ListBooks(Gtk.HBox):
    ...
    def __init__(self, parent):
        self.parent = parent
        self.db = listDB()
        try: self.last_books = pickle.load(open((join(asm_path.HOME_DIR, 'last-books.pkl')), "rb"))
    ...
    def add_to_lasts(self, id_book):
        ...
        try:
            output = open(join(asm_path.HOME_DIR, 'last-books.pkl'), 'wb')
    ...
    def build(self, *a):
        ...
        self.bookicon = GdkPixbuf.Pixbuf.new_from_file_at_size(join(asm_path.ICON_DIR, 'Book-128.png'), 120, 120)
        ...
        self.bookicon1 = GdkPixbuf.Pixbuf.new_from_file_at_size(join(asm_path.ICON_DIR, 'Book-128.png'), 28, 28)
