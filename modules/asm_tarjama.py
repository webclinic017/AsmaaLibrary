...
class Tarjama(Gtk.HPaned):
    rawa_anhe = {'خ':'البخاري في صحيحه، ', 
                'خت':'البخاري في صحيحه معلقا، ', 
                'بخ':'البخاري في الادب المفرد، ', 
                'عخ':'البخاري في خلق أفعال العباد، ', 
                'ز':'البخاري في جزء القراءة خلق الامام، ', 
                'ي':'البخاري في رفع اليدين، ', 
                'م':'مسلم في صحيحه، ', 
                'مق':'مسلم في المقدمة، ', 
                'د':'أبو داود في سننه، ', 
                'مد':'أبو داود في المراسيل، ', 
                'صد':'أبو داود في فضائل الانصار، ', 
